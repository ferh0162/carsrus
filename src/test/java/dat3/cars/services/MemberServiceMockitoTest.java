...
class MemberServiceMockitoTest {
  ...
  void getMembersAdmin() {
    ...
    m1.setCreated(LocalDateTime.now()); //Vi sætter selv tiden, for eller er den Null og kommer ikke med i databasen
    m2.setCreated(LocalDateTime.now()); //Fordi vi selv har valgt det i Member Entity

    //Nu bruger vi Mockito
